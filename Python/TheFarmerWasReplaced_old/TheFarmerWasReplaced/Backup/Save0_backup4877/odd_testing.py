...
#if ((get_pos_x() == ((((0) or (total_side_length % 2 == 1)) % (3)) != (total_side_length % 2 == 1))) and (get_pos_y() == ((((0) or (total_side_length % 2 == 1)) % (3)) != (total_side_length % 2 == 1)))): #all unique odds
    #do_a_flip()
    #print('unique')
    
#if ((get_pos_x() == ((0) or (total_side_length_positional % 2 == 1))) and (get_pos_y() == ((0) or (total_side_length_positional % 2 == 1)))): #lucky middle
    #do_a_flip()
    #print('lucky')

Xx3 = (((x == 0 or total_side_length % 2 == 1) * (3)) and ((x == total_side_length % 2 == 1) / (3)) == (total_side_length % 2 == 1)) and (((y == 0 or total_side_length % 2 == 1) * (3)) and ((y == total_side_length % 2 == 1) / (3)) == (total_side_length % 2 == 1))
#Yx3&

#### if 'not x' is added then at the end then it is only left-side and bottom-side ('or (0)' is required, 'and (0) can be added for sides only')

if get_pos_x() == get_pos_y() == Xx3 or (get_pos_x() == 0 and get_pos_y() == 0):
	do_a_flip()
    print('odd corner')
    

#elif ((get_pos_x() == ((((0) or (total_side_length % 2 == 1)) % (3)) == (total_side_length % 2 == 1))) and (get_pos_y() == ((((0) or (total_side_length % 2 == 1)) % (3)) == (total_side_length % 2 == 1)))): #factored by an odd
    #do_a_flip()
    #print('factored')
