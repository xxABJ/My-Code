...
void Bank_Account::Updation()
{
    ...
    cout << "\n\tUpdation of Bank Account Holder Name : ";
    cin.ignore();
    cin.getline(name, 50);
    cout << "\n\tUpdation of Type of Bank Account : ";
    cin >> type;
    type = toupper(type);
    cout << "\n\tUpdation of Balance Total-Money : ";
    cin >> Money_Deposit;
}
...
int main()
{
    ...
    do
    {
        ...
        cout << "\n\t\t3. Withdaw Money";
        cout << "\n\t\t4. BALANCE ENQUIRY";
        cout << "\n\t\t5. Display all Existing Bank Accounts";
...
void display_sp(int n)
{
    ...
    if (!inFile)
    {
        cout << "File Failed to open !! Press any Key...";
        return;
    }
    cout << "\n\tBALANCE DETAILS\n";
    while (inFile.read(reinterpret_cast<char *>(&ac), sizeof(Bank_Account)))
