...
#    result = apply_formula(user_input)
#    print("Result:", result)
#
...
def main():
    ...
    while len(result) < len(user_input):
        result += apply_formula(user_input[len(result):])
