class Right:
    ...
    class assigner:
        ...
        def cache_assignment(self, cache_batch: int, latest_assignment: tuple) -> None:
            ...
            Right.cached_directions[(cache_batch, latest_assignment[0])] = (latest_assignment[1][0], latest_assignment[1][1])
            ...
            for assignments in range(1, 1 + (self.amount_of_moves)):
                ...
                if grid[previous_pos[0]][previous_pos[1] + 1] == "S":
                    ...
                    if self.print_console:
                        ...
                        print("│")
                        print("├ Getting factored condition and value for RIGHT CLASS:")
                        ...
                        print(f"* RIGHT CLASS * inserting in grid: {self.assignSystem.arrows.get(current_direction)}", end= " ")
                    ...
                    if self.print_console:
                        ...
                        k = 0
                        for key, value in Right.cached_directions.items():
