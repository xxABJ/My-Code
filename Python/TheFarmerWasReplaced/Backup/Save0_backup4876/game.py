...
tro_full_column_moved_y = ((total_side_length_positional - y) * (total_side_length))
tro_moves = (((tro_full_column_moved_y % 2 == 0) and (total_side_length - x)) or (((tro_full_column_moved_y > 0) and (tro_full_column_moved_y % 2 == 1)) and (x + 1)))
...
tl_full_column_moved_y = ((total_side_length_positional - y) * (total_side_length))
tl_moves = (((tl_full_column_moved_y % 2 == 0) and (x + 1)) or ((tl_full_column_moved_y > 0) and (tl_full_column_moved_y % 2 == 1) and ((total_side_length_positional - x) + (1))))
