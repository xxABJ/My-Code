...
full_column_moved = total_side_length_positional

#Starting at bottom_left (bl) moves' calculator.

#full_column_moved = total_side_length_positional
#moves_north = y
bl_moves_south = (total_side_length - y)
bl_moves_completed = (x * full_column_moved) + (bl_moves_south)
...
br_moves_completed = (y * full_column_moved_x) + (br_moves_west)
...
full_column_moved = total_side_length_positional
moves_north = y
#moves_south = (total_side_length - total_side_length_positional)
moves_completed = (x * full_column_moved_x) + (moves_north)
moves_remaning = (required_moves_per_rotation - moves_completed)
