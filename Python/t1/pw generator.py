...
def print_password(length: int) -> None:
    pw = ""
    for letter in range(length):
        random_1 = random.choice(letters)
        random_2 = random.choice(Cletters)
        random_3 = random.choice(Sletters)
        random_4 = random.choice(numbers)
        random_letter_variables = random_1, random_2, random_3, random_4
...
def generate_password() -> None:
    ...
    if required_length.isdigit():
        ...
        error_label_str.set(value= 'MUST BE EMPTY / A VALID NUMBER !')
