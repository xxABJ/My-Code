...
class Game:
    ...
    def run(self):
        ...
        next_direction = "default"  # Store the next direction to apply
            ...
            while not self.game_logic.stop:
                ...
                for event in pygame.event.get():
                    ...
                    if event.type == Game.PLAYING:
                        ...
                        self.snake.snake_movements(next_direction)
                        next_direction = "default"  # Reset to continue in current direction
                    ...
                    if event.type == pygame.KEYDOWN:
                        ...
                        if event.key == pygame.K_LEFT and self.snake.moving_direction != 'right':

                            next_direction = 'left'
                    

                        if event.key == pygame.K_RIGHT and self.snake.moving_direction != 'left':

                            next_direction = 'right'
                    

                        if event.key == pygame.K_UP and self.snake.moving_direction != 'down':

                            next_direction = 'up'
                    
                    
                        if event.key == pygame.K_DOWN and self.snake.moving_direction != 'up':
